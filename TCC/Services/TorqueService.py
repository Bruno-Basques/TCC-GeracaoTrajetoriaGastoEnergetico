...
def calculo_torque_elo1(tempo_discretizacao_somatorio, elo1_inercia, elo1_massa, elo1_comprimento,
                                  elo2_inercia, elo2_massa, elo2_comprimento,
                                  ...
                                  lista_velocidades_angulares_theta1, lista_velocidades_angulares_theta2,
                                  motor_torque_atrito, motor_momento_inercia, motor_coeficiente_atrito_viscoso):
    """
    ...
    for a in range(tempo_discretizacao_somatorio):
        ...
        torq_gera1 = motor_torque_atrito + torq_1 + motor_momento_inercia * lista_aceleracoes_angulares_theta1[a] + \
            motor_coeficiente_atrito_viscoso * lista_velocidades_angulares_theta1[a]
        list_torq_gera1.append(torq_gera1)
    return   list_torq_gera1

def calculo_torque_elo2(tempo_discretizacao_somatorio, elo1_comprimento,
                                  elo2_inercia, elo2_massa, elo2_comprimento,
                                  lista_pontos_interm_espaco_juntas1, lista_pontos_interm_espaco_juntas2,
                                  lista_aceleracoes_angulares_theta1, lista_aceleracoes_angulares_theta2,
                                  lista_velocidades_angulares_theta2,
                                  motor_torque_atrito, motor_momento_inercia, motor_coeficiente_atrito_viscoso,
                                  motor_constante_torque, motor_resistencia_armadura, motor_indutancia_armadura,
                                  infinitesimal_discretizacao, motor_constante_proporcionalidade_tensao_velocidade):
    """
    ...
    for c in range(tempo_discretizacao_somatorio):
        ...
        torq_gera2 = motor_torque_atrito + torq_2 + motor_momento_inercia * lista_aceleracoes_angulares_theta2[
            c] + motor_coeficiente_atrito_viscoso * lista_velocidades_angulares_theta2[c]
