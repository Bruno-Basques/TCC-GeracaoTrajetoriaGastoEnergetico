...
acel_cartesiana = \
    aceleracao_linear(parametro_x_inicial,
                      parametro_x_final,
...
for e in range(1, 50):
    ...
    pontos_interm_espaco_cartesiano = trajetoria_linear_simples(trajetoria.tempo_somatorio(),
                                                                parametro_x_inicial,
                                                                parametro_x_final,
                                                                acel_cartesiana)
    ...
    while h < trajetoria.tempo_somatorio():
        ...
        theta1, theta2 = \
            cinematica_inversa_posicoes_junta_1e2(pontos_interm_espaco_cartesiano[h],
                                                  parametro_y,
                                                  elo1.comprimento(),
                                                  elo2.comprimento())
    ...
    while i < trajetoria.tempo_somatorio() - 2:
        ...
        velocidades_angulares_theta1.append(
            velocidade_angular(pontos_interm_espaco_junta1[i], pontos_interm_espaco_junta1[i + 1],
                               trajetoria.infinitesimal()))

        # Adicionando as velocidades calculadas ponto a ponto da junta 2
        velocidades_angulares_theta2.append(
            velocidade_angular(pontos_interm_espaco_junta2[i], pontos_interm_espaco_junta2[i + 1],
                               trajetoria.infinitesimal()))

        i += 1

    velocidades_angulares_theta1.append(0)
    velocidades_angulares_theta2.append(0)

    aceleracoes_angulares_theta1 = list()
    aceleracoes_angulares_theta2 = list()

    aceleracoes_angulares_theta1.append(0)
    ...
    while j < trajetoria.tempo_somatorio() - 2:
        ...
        aceleracoes_angulares_theta2.append(
            (velocidades_angulares_theta2[j + 1] - velocidades_angulares_theta2[j]) /
            trajetoria.infinitesimal())
    ...
    torque_elo1_trajetoria_retilinea = \
        calculo_torque_elo1(trajetoria.tempo_somatorio(),
                            elo1.inercia(), elo1.massa(),
                            elo1.comprimento(),
                            elo2.inercia(), elo2.massa(),
                            elo2.comprimento(),
    ...
    torque_elo2_trajetoria_retilinea = \
        calculo_torque_elo2(trajetoria.tempo_somatorio(),
                            elo1.comprimento(),
                            elo2.inercia(), elo2.massa(),
                            elo2.comprimento(),
                            pontos_interm_espaco_junta1,
...
print('\n')
eixo_y_grafico_PIJ1 = list(map(lambda pontos_y_pij1: pontos_y_pij1 * 180 / pi, pontos_interm_espaco_junta1))
...
print('\n')
eixo_y_grafico_VAJ1 = list(map(lambda pontos_y_vaj1: pontos_y_vaj1 * 180 / pi, velocidades_angulares_theta1))
...
print('\n')
eixo_y_grafico_AAJ1 = list(map(lambda pontos_y_aaj1: pontos_y_aaj1 * 180 / pi, aceleracoes_angulares_theta1))
...
print('\n')
eixo_y_grafico_PIJ2 = list(map(lambda pontos_y_pij2: pontos_y_pij2 * 180 / pi, pontos_interm_espaco_junta2))
...
print('\n')
eixo_y_grafico_VAJ2 = list(map(lambda pontos_y_vaj2: pontos_y_vaj2 * 180 / pi, velocidades_angulares_theta2))
...
print('\n')
eixo_y_grafico_AAJ2 = list(map(lambda pontos_y_aaj2: pontos_y_aaj2 * 180 / pi, aceleracoes_angulares_theta2))
